...
class PSPNet(BaseModel):
    ...
    #       return output, aux
   #    return output
            return self.softmax(output), aux     # 添加softmax操作
...
class PSPDenseNet(BaseModel):
    def __init__(self, num_classes, in_channels=3, backbone='densenet201', pretrained=True, use_aux=False, freeze_bn=False, **_):
